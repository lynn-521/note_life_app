...
abstract class _Idle<T> extends AsyncState<T> {
...
abstract class _ErrorState<T> extends AsyncState<T> {
  const factory _ErrorState(final Object error) = _$ErrorStateImpl<T>;
